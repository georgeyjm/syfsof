  ...
  <section class="p-10 mt-10" style="min-width: 0" aria-label="Main page content">
    ...
    <form>   
      ...
      <div class="relative">
          ...
          <input @input="searchFood" type="search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div v-if="query !== ''">
      <div class="flex flex-wrap">
        <ShopPageItemCard :title="food.foodInfo.name" v-for="food in recommendedFood" />
      </div>
    </div>
...
<script>
  ...
  // thomas's eth
  const sellers = ['0xfeB23A728C560e7D186523eC2C90298f1eE1Ea1a']
